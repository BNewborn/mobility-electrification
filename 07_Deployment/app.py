...
def render_content(tab):
    ...
    ### https://dash.plotly.com/dash-core-components/markdown
        ...
        return html.Div([
            ...
            An example of running the entire models can be found [here](https://github.com/BNewborn/mobility-electrification/blob/main/05_Commuter_Electric_Pipeline/Make_Objects_For_Dashboarding_Scenarios_V3.ipynb)
            """
                    ),link_target="_blank"),
                    html.Br(),
                            dcc.Markdown(dedent(
            ...
            **Part 1: Commuter Model**
            ...
            You can run the code of **commuter_model.py** [here](https://github.com/BNewborn/mobility-electrification/blob/main/05_Commuter_Electric_Pipeline/commuter_model/commuter_model.py)

            The details and sources for the Eligibility Model can be found [here](https://github.com/BNewborn/mobility-electrification/blob/main/05_Commuter_Electric_Pipeline/commuter_model/README.md)

            The WFH conditional probabilities can be found [here](https://github.com/BNewborn/mobility-electrification/blob/main/05_Commuter_Electric_Pipeline/commuter_model/wfh_conditional_probs.csv)

            """
                    ),link_target="_blank"),                    
                            html.Img(src=app.get_asset_url("model-1.jpg")),
                            html.Br(),
                            html.Br(),
                            dcc.Markdown(dedent(
                        """
            Sample Codes
            ```python
            ### sample codes of Eligibility Model
            ...
            **Part 2: Energy Model**
            ...
            You can run the code of **electrical_model.py** [here](https://github.com/BNewborn/mobility-electrification/blob/main/05_Commuter_Electric_Pipeline/electrical_model/electrical_model.py)

            The detailed EV Technical Information can be find [here](https://github.com/BNewborn/mobility-electrification/blob/main/05_Commuter_Electric_Pipeline/electrical_model/EV_reference_table.csv)
            """
                    ),link_target="_blank"),                    
                            html.Img(src=app.get_asset_url("model-2.jpg")),
                            html.Br(),
                            html.Br(),
                            dcc.Markdown(dedent(
                        """
            ...
            """
                    ...
                    html.Br(),
                            dcc.Markdown(dedent(
                        """
            **Grid Capacity Computation.** We use a synthetic but realistic network model of the New York power system with 1,814 buses, 2,202 high voltage transmission lines, and 395 generators to quantify the upper bound for the maximum instantaneous power that can be supplied to Manhattan.
            """
                    ),link_target="_blank"),
                        ], 
        ...
        return html.Div([
            ...
            [Jingrong Zhang](https://zhangjingrong.com/About-me), *Researcher, Visualization Lead*      

            [Amber Jiang](https://www.linkedin.com/in/amber-ming-jiang/), *Researcher, Subject Matter Expert*

            [Brian Newborn](), *Researcher, Data Analysis Lead*

            [Robert Mieth](https://scholar.google.com/citations?user=xF6QXAUAAAAJ&hl=en), *Postdoctoral Researcher, Scientific Advisor*    
            ...
            [Center for Urban Science + Progress](https://cusp.nyu.edu/) is a unique research center at the NYU Tandon School of Engineering dedicated to the interdisciplinary application of science, technology, engineering, and mathematics in the service of urban communities across the globe.

            [Yury Dvorkin](https://scholar.google.com/citations?user=lI2PTkAAAAAJ&hl=en), *Associate Professor, Faculty Mentor*
            ...
            [IPUMS USA](https://usa.ipums.org/usa/), University of Minnesota, [www.ipums.org](https://www.ipums.org/)
            ...
            [Power Plants & Transmission lines](https://atlas.eia.gov/apps/eia::electricity/explore), Homeland Infrastructure Foundation-Level Data (HIFLD), [hifld-geoplatform.opendata.arcgis.com](https://hifld-geoplatform.opendata.arcgis.com/)   

            [EV Charging Stations](https://afdc.energy.gov/stations/#/find/nearest), Alternative Fuels Data Center, U.S. Department of Energy, [https://afdc.energy.gov/](https://afdc.energy.gov/)            
            """
                    ),link_target="_blank"),                    
                        ], 
                        className="commuter_model_1 card_container"
            ...
            StoryMaps / Project Website: https://arcg.is/WrvSf

            GitHub Repo: https://github.com/BNewborn/mobility-electrification        
            ...
            [Showcase](https://nycsodata23.sched.com/event/1JUaX/the-electric-commute-envisioning-100-electrified-mobility-in-new-york-city), [NYC School of Data](https://schoolofdata.nyc/), NYC Open Data Week 2023
...
def update_electric_graph(transit_pattern,wfh_level,Detailed,pev_delay_choice,season,wind_level):
    ...
    e_tmp_profile = e_tmp_profile[e_tmp_profile["PEV_DELAY"]!="Custom"].merge(right=load_df, on=["Charge_Hour"])
